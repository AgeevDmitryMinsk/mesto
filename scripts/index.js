...
const handleFormSubmit = (evt) => { // объявляем функцию, реализующую сохранение значений полей ввода данных и отправку формы;
  ...
  closePopup(popup); // реализуем автоматическое закрытие "Попап-окна";
}
...
closeButton.addEventListener('click', () => closePopup(popup)); // подключаем "слушатель", вызывающий функцию "closePopup" при нажатии на кнопку "Закрыть";
